...
public final class FragmentRewardsBinding implements ViewBinding {
  ...
  private FragmentRewardsBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView6) {
  ...
  public static FragmentRewardsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRewardsBinding((ConstraintLayout) rootView, textView6);
    }
